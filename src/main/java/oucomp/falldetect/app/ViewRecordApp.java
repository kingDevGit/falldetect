...
public class ViewRecordApp extends javax.swing.JFrame implements RecordSelectListener {

  private AccelDataset theDataset = null;

  public ViewRecordApp() {
    initComponents();
  ...
  public static void main(String args[]) {
    ...
    try {
      ...
      java.util.logging.Logger.getLogger(ViewRecordApp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    java.awt.EventQueue.invokeLater(new Runnable() {
      public void run() {
        new ViewRecordApp().setVisible(true);
      }
    });
  }
